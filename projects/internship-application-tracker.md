...
summary: "Tracking internship applications using iMAP and Python to streamline the application process."
---

<img class="img-fluid rounded float-start me-3 mb-3" src="../img/internship_tracker_automation_test.png" alt="Internship Tracker Automation Test" style="max-width: 300px; height: auto;">
