...
For this technical essay, you will write an interesting and informative technical essay that ends up answering the following two questions, “What are design patterns?” and “What design patterns are used in your final project?”. By doing so, you’ll be better prepared to answer this question if it comes up in an interview.

Do not, under any circumstances, write two paragraphs, one with the title “What are design patterns?” and one with the title “What design patterns are used in your final project” That will get you no points, as such an essay would be too boring for anyone to read.
